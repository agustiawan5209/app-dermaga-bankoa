<div>
                            ...
                            <div class="w-full flex flex-col justify-start items-start space-y-8">
                                ...
                                <div class="flex justify-start items-start flex-col space-y-2 w-full">
                                    <table class="w-full">
                                        ...
                                        <tr class="text-sm  leading-none text-gray-800">
                                            <td class=" text-gray-800">Jam Berangkat: </td>
                                            <td class="text-left">
                                                <x-jet-input type="time" wire:model='jam_berangkat'
                                        ...
                                        <tr class="text-sm  leading-none text-gray-800">
                                            <td class=" text-gray-800">Jam Kembali: </td>
                                            <td class="text-left">
                                                <x-jet-input type="time" wire:model='jam_kembali'
                                                    class=" text-center w-full" />
                                            </td>
                                        </tr>
                                    </table>
    ...
    <div class='w-full'>
        <div class="flex flex-row items-center justify-center relative">
            ...
            <div id="partnerCard"
                class="bg-[#1c1c1c] text-gray-50 overflow-hidden rounded-md max-w-md p-2 min-h-[500px] flex flex-col w-1/2">
                <div>
                        ...
                        <div class=" text-lg col-span-3 border-b border-b-white">
                            <h4 class="font-bold flex justify-between">
                                ...
                                <span class="cursor-pointer">
                                    ...
                                    <svg x-show="bankID == {{ $item->id }}" x-on:click="bankID = 0"
            ...
            <form enctype="multipart/form-data" action="{{ route('Kirim-Bayar') }}" method="POST"
                ...
                <input type="hidden" name="jadwal_berangkat" wire:model='jadwal_berangkat'>
                <input type="hidden" name="jam_berangkat" wire:model='jam_berangkat'>
                <input type="hidden" name="jam_kembali" wire:model='jam_kembali'>
                <input type="hidden" name="jadwal_kembali" wire:model='jadwal_kembali'>
