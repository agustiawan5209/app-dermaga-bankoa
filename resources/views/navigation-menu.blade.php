    ...
    <ul class="mt-3">
        <li class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Dashboard.Pemilik') ?  'bg-white text-gray-700' :'text-gray-400 hover:text-gray-300' }}">
            <a href="{{ route('Admin.Dashboard.Pemilik') }}"
                class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                <i class="fas fa-home fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Home</span>
            </a>
        </li>
        <li class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Data-Pelanggan') ?  'bg-white text-gray-700' :'text-gray-400 hover:text-gray-300' }}">
        ...
        <li class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Data-Destinasi') ?  'bg-white text-gray-700' :'text-gray-400 hover:text-gray-300' }}">
        ...
        <li class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Data-Ulasan') ?  'bg-white text-gray-700' :'text-gray-400 hover:text-gray-300' }}">
            <a href="{{ route('Admin.Data-Ulasan') }}"
                class="bl flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                <i class="fas fa-chart-area fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Ulasan</span>
            </a>
        </li>
        <li class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Metode-Pembayaran') ?  'bg-white text-gray-700' :'text-gray-400 hover:text-gray-300' }}">
