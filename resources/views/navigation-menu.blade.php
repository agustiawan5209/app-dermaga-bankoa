<ul class="mt-3">
    ...
    <li
        class="flex w-full justify-between cursor-pointer items-center py-3 pl-4 {{ request()->routeIs('Admin.Data-Tr-Pemberangkatan') ? 'bg-white text-gray-700' : 'text-gray-400 hover:text-gray-300' }}">
